...
public class JoystickF310 extends IJoystick {
	...
	public JoystickF310(int port) {
		super(port);
		add("DriveLeft", new ValueUsage(Axis.LEFT_Y, true));
		add("DriveRight", new ValueUsage(Axis.RIGHT_Y, false));
		add("Feed", new ValueUsage(Keys.BUMPER_LEFT, false));
		add("Shoot", new ValueUsage(Keys.BUMPER_RIGHT, false));
	}
